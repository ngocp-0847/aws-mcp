 ...
 */
function enrichSchemaWithPrompts(zodSchema, parameterPrompts) {
    ...
    if (zodSchema instanceof z.ZodObject) {
        ...
        for (const [key, fieldSchema] of Object.entries(shape)) {
            ...
            if (fieldSchema instanceof z.ZodEnum) {
                propertySchema.enum = fieldSchema._def.values;
            }
            // Handle default values from Zod
            if (fieldSchema instanceof z.ZodDefault) {
                propertySchema.default = fieldSchema._def.defaultValue();
            }
...
function getJsonSchemaType(zodSchema) {
    ...
    if (zodSchema instanceof z.ZodOptional)
        return getJsonSchemaType(zodSchema.unwrap());
    if (zodSchema instanceof z.ZodDefault)
        return getJsonSchemaType(zodSchema.removeDefault());
